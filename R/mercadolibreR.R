#' \code{mercadolibreR} package
#'
#' A Quick and Easy Wrapper for Seller and Listing Data from MercadoLibre's Web API
#'
#' See the README on
#' \href{https://github.com/njcorona/mercadolibreR#readme}{GitHub}
#'
#' @docType package
#' @name mercadolibreR
